...
contract DiamondTOKEN is TRC20Detailed, TRC20 {
    ...
    uint public startTime = 1603735200;
    ...
    function transfer(address to, uint value) public checkStart returns (bool) {
    ...
    function transferFrom(address from, address to, uint value) public checkStart returns (bool) {
        uint burnRate = getBurnRate();
        uint transferAmount = value;
